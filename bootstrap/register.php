...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Noah C. Woods</a>
    ...
    <section id="projects" class="projects-section bg-light">
      <div class="container">
        ...
        <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
          <div class="col-lg-6">
            <img class="img-fluid" src="img/linux-logo.jpg" alt="" width="100%" height="100%">
          </div>
          <div class="col-lg-6">
            <div class="bg-black text-center h-100 project">
              <div class="d-flex h-100">
                <div class="project-text w-100 my-auto text-center text-lg-left">
                  ...
                  <p class="mb-0 text-white-50">NOAHOS was started as a way to better understand the linux operating system. This OS was created following
                  the Linux From Scratch guide book and is still currently in development. A download will be listed after completion of NOAHOS.</p>
